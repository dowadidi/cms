...
class Elements extends Component
{
     ...
     * @since 3.2.0
     */
    public function resaveElements(ElementQueryInterface $query, bool $continueOnError = false, $skipRevisions = true, bool $updateSearchIndex = null, bool $tryDuplicate = false)
    {
